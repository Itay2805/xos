...
USB_CONFIGURATION_LENGTH	= 0
USB_CONFIGURATION_TYPE		= 1
USB_CONFIGURATION_TOTAL_LENGTH	= 2
USB_CONFIGURATION_INTERFACES	= 4
USB_CONFIGURATION_VALUE		= 5
USB_CONFIGURATION_STRING	= 6
USB_CONFIGURATION_SIZE		= 9

USB_INTERFACE_LENGTH		= 0
USB_INTERFACE_TYPE		= 1
USB_INTERFACE_ENDPOINTS		= 4
USB_INTERFACE_CLASS		= 5
USB_INTERFACE_SUBCLASS		= 6
USB_INTERFACE_PROTOCOL		= 7
USB_INTERFACE_STRING		= 8
USB_INTERFACE_SIZE		= 9

USB_ENDPOINT_LENGTH		= 0
USB_ENDPOINT_TYPE		= 1
USB_ENDPOINT_ADDRESS		= 2
USB_ENDPOINT_TRANSFER_TYPE	= 3
USB_ENDPOINT_MAX_PACKET		= 4
USB_ENDPOINT_INTERVAL		= 6
USB_ENDPOINT_SIZE		= 7
